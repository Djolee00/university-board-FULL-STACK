package rs.ac.bg.fon.fileservice.web.handler;
...
public class FileExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleFileEmptyException(
        ...
        return handleExceptionInternal(
                ex, bodyOfResponse, new HttpHeaders(), HttpStatus.NO_CONTENT, request);
    }
    ...
    // Handle exceptions that occur when the call was transmitted successfully, but Amazon S3
    // couldn't process
    ...
    // Handle exceptions that occur when Amazon S3 couldn't be contacted for a response, or the
    // client
    ...
    @ExceptionHandler(
            value = {IOException.class, FileNotFoundException.class, MultipartException.class})
